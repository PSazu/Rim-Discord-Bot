        ...
        message.channel.send({
            embed: {
                ...
                fields: [{
                    ...
                    '\n \n' + "`2.` Music message send - ийг сайжруулах" + '\n \n' + "Өгөгдлийн сан нэмэх ба хэрэглэгч нь өөрийн гэсэн дууны playlist, одоо тоглож байгаа queue-г хадгалж авдаг болгох. Ингэснээр дараа дахиж хүссэн цагтаа сонсдог болгох"
                    + '\n \n' +  '`3.` Twitch notify - Дуртай streamer - ийнхаа live - ийг мэдэлгүй өнгөрөөвөл тэнэг биз дэ ¯\_(ツ)_/¯.' + '\n \n' +
                    "`4.` Олон улсын хэл дэмждэг болгох жишээ нь Монгол, Англи, Япон хэлнээс эхлээд явах байх. Мэдээж default хэл нь `Англи хэл`"
                 }],
                 image: {
